/**
 * COMPONENTE: RealTimeDeliveryMap
 * 
 * Mapa interactivo de entrega en tiempo real utilizando WebView + Leaflet.js
 * 
 * Características:
 * - 🏠 Marcador del cliente (verde, fijo)
 * - 🏍️ Marcador del repartidor (naranja, actualización en vivo)
 * - 🏪 Marcador del restaurante (azul, fijo)
 * - 📍 Ruta optimizada calculada con OSRM
 * - 🗺️ Mapa base de OpenStreetMap (gratuito)
 * - ➕➖ Controles de zoom personalizados
 * 
 * Tecnología:
 * - WebView: Renderiza HTML con JavaScript
 * - Leaflet.js: Librería de mapas open source
 * - OSRM API: Cálculo de rutas en tiempo real
 * 
 * Actualización en vivo:
 * - Escucha cambios de ubicación del driver vía props
 * - Inyecta JavaScript para actualizar marcador sin recargar
 * - Recalcula ruta automáticamente con cada actualización
 * 
 * @component
 * @example
 * ```tsx
 * <RealTimeDeliveryMap
 *   customerLocation={{ latitude: 4.60971, longitude: -74.08175 }}
